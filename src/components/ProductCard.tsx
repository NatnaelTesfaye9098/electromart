...
export default function ProductCard({id, name, price, imageUrl, description}: ProductCardProps) {
    ...
    return(
        <Card className="pt-0 bg-gray-800 rounded-xl shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl flex flex-col flex-grow h-full border border-gray-700">
